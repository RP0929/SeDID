...
def get_FLAGS(flag_path):
    ...
    # Logging & Sampling
    flags.DEFINE_string('logdir', './logs/DDPM_SVHN_EPS', help='log directory')
    ...
    flags.DEFINE_string('fid_cache', './stats/SVHN.train.npz', help='FID cache')
    #SeDID
    flags.DEFINE_string('ckpt_sample_path', '/home/mrp_929/projects/SeDID/logs/DDPM_SVHN_EPS/ckpt-step1200000_samples.pt', help='ckpt_sample_path')
    flags.DEFINE_string('output_folder_path', 'generated_images/DDPM_SVHN', help='FID cache')
    flags.DEFINE_string('ckpt', '/home/mrp_929/projects/SeDID/logs/DDPM_SVHN_EPS/ckpt-step1200000.pt', help='FID cache')
...
def secmi_stat(model, FLAGS, batch_size=128, score_type='mse'):
    ...
    real_dataset = torchvision.datasets.SVHN(root='/home/mrp_929/projects/SeDID/datasets', download=True, transform=transforms)
    ...
    generated_loader = prepare_generated_data_loader(FLAGS.ckpt_sample_path, FLAGS.output_folder_path, transforms, batch_size=128)
    ...
    def get_recon_score(data_loader, ddim_reverse_step, ddim_denoise_step, score_type='ssim'):
        ...
        for batch_idx, x in tqdm.tqdm(enumerate(data_loader)):
            ...
            all_internal_diffusions.append(internal_diffusions.cpu())
            all_internal_samples.append(internal_samples.cpu())
...
if __name__ == '__main__':
    fix_seed()
    flag_path = os.path.join("/home/mrp_929/projects/SeDID/SVHN/flagfile.txt")
    device = 'cuda'
