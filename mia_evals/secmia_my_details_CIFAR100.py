...
def get_FLAGS(flag_path):
    ...
    # Logging & Sampling
    flags.DEFINE_string('logdir', './logs/DDPM_CIFAR100_EPS', help='log directory')
    ...
    flags.DEFINE_string('fid_cache', './stats/CIFAR100.train.npz', help='FID cache')
    #SeDID
    flags.DEFINE_string('ckpt_sample_path', '/home/mrp_929/projects/SeDID/logs/DDPM_CIFAR100_EPS/ckpt-step1200000_samples.pt', help='ckpt_sample_path')
    flags.DEFINE_string('output_folder_path', 'generated_images/DDPM_CIFAR100', help='FID cache')
    flags.DEFINE_string('ckpt', '/home/mrp_929/projects/SeDID/logs/DDPM_CIFAR100_EPS/ckpt-step1200000.pt', help='FID cache')
...
def secmi_stat(model, FLAGS, batch_size=128, score_type='mse'):
    ...
    real_dataset = torchvision.datasets.CIFAR100(root='/home/mrp_929/projects/SeDID/datasets', train=True, download=True, transform=transforms)
...
if __name__ == '__main__':
    fix_seed()
    flag_path = os.path.join("/home/mrp_929/projects/SeDID/CIFAR100/flagfile.txt")
    device = 'cuda'
