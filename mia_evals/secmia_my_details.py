...
def get_FLAGS(flag_path):
    ...
    #SeDID
    flags.DEFINE_string('ckpt_sample_path', '/home/mrp_929/projects/SeDID/logs/DDPM_CIFAR10_EPS/ckpt-step1200000_samples.pt', help='ckpt_sample_path')
    flags.DEFINE_string('output_folder_path', 'generated_images/DDPM_CIFAR10', help='FID cache')
    flags.DEFINE_string('ckpt', '/home/mrp_929/projects/SeDID/logs/DDPM_CIFAR10_EPS/ckpt-step100000.pt', help='FID cache')
...
def secmi_stat(model, FLAGS, batch_size=128, score_type='ssim'):
    timestep = 199
    print(timestep)
    ...
    real_dataset = torchvision.datasets.CIFAR10(root='/home/mrp_929/projects/data', train=True, download=True, transform=transforms)
...
if __name__ == '__main__':
    fix_seed()
    flag_path = os.path.join("/home/mrp_929/projects/SeDID/CIFAR10/flagfile.txt")
    device = 'cuda'
